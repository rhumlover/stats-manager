...
### Web browser
- [stats-manager.js](http://s2.dmcdn.net/IFADE.js)
- [stats-manager.min.js](http://s2.dmcdn.net/IFAC0.js)
- [stats-manager.require.js](http://s1.dmcdn.net/IE_3T.js)
- [stats-manager.require.min.js](http://s1.dmcdn.net/IFACn.js)
